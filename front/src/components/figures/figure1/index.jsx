    ...
    return (
        ...
        <section className='section-figure'>
            ...
            <figure className='figure-figure'>
                ...
                <img className='img-figure img-figure-pelucia' src="/assets/images/figures/figure1/figure1.png" alt="Foto Boneco de Pelucia Pikachu" />

            </figure>

            <article className='article-figure'>

                <p className='p-figure'>Pokémon - Pelúcia De 20 Cm - Pikachu</p>
